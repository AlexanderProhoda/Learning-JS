...
function pow(x, n) {
  let result = 1; 
  // Здесь надо было добавить отдельную строку для читаемости. Добавил
  for (let i = 0; i < n ; i++ ) {
      result *= x;
    }
    // Здесь надо было добавить отдельную строку для читаемости. Добавил
...
if (n <= 0) {
  alert(`Степень ${n} не поддерживается,
   введите целую степень, большую 0`); //Здесь надо было разбить на отдельные строки для читаемости. Добавил
} else {
  alert(pow(x, n) )
}
/* Решение 
